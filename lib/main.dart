    ...
    ChangeNotifierProvider(
      ...
      child: MaterialApp(
        theme: ThemeData(
          ...
          scaffoldBackgroundColor: const Color.fromARGB(255, 133, 95, 125),
        ),
        home: const Tasks(),
      ),
    ),
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    userTheme
                        .incrementCount(); // Appel de la méthode pour incrémenter le compteur
                  },
                  child: const Text('Increment'),
                ),
                ElevatedButton(
                  onPressed: () {
                    userTheme.changeBackgroundColor(Colors
                        .purple); // Appel de la méthode pour changer la couleur de l'arrière-plan
                  },
